...
const sprints: ReadonlyArray<Sprint> = [
  {
    ...
    feats: [
      ...
      F("Définition des domaines, des rôles", " et des parcours utilisateurs."),
      F("Modélisation de la logique de remplacement rotatif", "."),
  ...
  },
  {
    ...
    name: "Design UI/UX",
    feats: [
      F("Maquettes des écrans principaux", " : inscription, missions, matching, calendrier."),
      F("", "Design des parcours titulaire et remplaçant."),
  ...
  },
  {
    ...
    num: "3",
    days: "J19–J30",
    name: "Profils, comptes & back-office",
    feats: [
      F("Inscription, authentification", " et gestion des rôles (titulaire / remplaçant)."),
      F("Profils professionnels", " avec domaines et qualifications."),
      F("", "Back-office et vérification des profils, gestion des domaines et utilisateurs."),
      F("", "Système de modération et tableau de bord administrateur."),
    ],
    tags: [cy("Comptes & profils"), nv("Back-office")],
  },
  {
    hasPhase: false,
    leftBg: ACC,
    num: "4",
    days: "J31–J44",
    name: "Missions, matching & calendrier",
    feats: [
      F("Publication de missions", " (ponctuelles et rotatives)."),
      F("Moteur de recherche et de matching intelligent", "."),
      F("Calendrier de disponibilités", " et de missions."),
      F("", "Candidature, acceptation et confirmation des missions."),
      F("", "Premier build de test (TestFlight / APK) et itérations."),
    ],
    tags: [cy("Cœur fonctionnel"), nv("Matching & calendrier")],
  },
  {
    hasPhase: false,
    leftBg: ACC,
    num: "5",
    days: "J45–J54",
    name: "Messagerie, notifications & évaluations",
    feats: [
      F("Messagerie interne", " entre titulaires et remplaçants."),
      F("Notifications push", " temps réel à chaque étape clé."),
      F("", "Système d’évaluation mutuelle et historique des missions."),
      F("", "Signalement, gestion de la confiance et intégration de la monétisation."),
    ],
    tags: [cy("Confiance & monétisation"), nv("Messagerie")],
  },
  {
    hasPhase: true,
    phaseNum: "4",
    ...
    <div className={styles.root} data-devis-root>
      ...
      <main className={styles.main}>
        ...
        <Cover
          ...
          subtitle="Découpage détaillé du développement de RotaPro sur 60 jours — 6 sprints, livraison itérative avec validation à chaque étape. Aligné sur l’échéancier du devis."
          badges={coverBadges}
          meta={coverMeta}
        />
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  Meta Ads et Apple Search Ads, et suivi hebdomadaire des KPIs pour atteindre
                  l’objectif de 1 000 utilisateurs actifs.
                </p>
              </div>
            </div>
          </div>
        ...
        <Footer
          ...
          text="Ce calendrier accompagne le devis et le cahier des charges. Sprint après sprint, vous voyez RotaPro prendre forme jusqu’à la mise en marché."
        />
      </main>
      <ScrollReveal />
    </div>
